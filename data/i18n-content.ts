...
export const CONTENT: Record<string, Tr> = {
  ...
  "Bienvenue dans l'appartement Saint-Jean, en plein cœur de Caen ! Vous êtes rue Saint-Jean, à deux pas des restaurants, des commerces et du port — tout se fait à pied. Son petit plus : un balcon avec vue sur les toits de Caen, parfait pour un café le matin ou un verre le soir. Bon à savoir : le logement se situe au 3ᵉ étage, sans ascenseur. Très bon séjour ! ☕":
    {
      en: "Welcome to the Saint-Jean apartment, right in the heart of Caen! You're on Rue Saint-Jean, just steps from restaurants, shops and the harbour — everything is within walking distance. Its little extra: a balcony overlooking the rooftops of Caen, perfect for a morning coffee or an evening drink. Good to know: the apartment is on the 3rd floor, with no lift. Enjoy your stay! ☕",
      de: "Willkommen in der Wohnung Saint-Jean, mitten im Herzen von Caen! Sie wohnen in der Rue Saint-Jean, nur wenige Schritte von Restaurants, Geschäften und dem Hafen entfernt – alles ist zu Fuß erreichbar. Das kleine Extra: ein Balkon mit Blick über die Dächer von Caen, perfekt für einen Kaffee am Morgen oder einen Drink am Abend. Gut zu wissen: Die Wohnung befindet sich im 3. Stock, ohne Aufzug. Einen schönen Aufenthalt! ☕",
      es: "¡Bienvenido al apartamento Saint-Jean, en pleno corazón de Caen! Está en la rue Saint-Jean, a dos pasos de restaurantes, comercios y del puerto: todo se hace a pie. Su pequeño plus: un balcón con vistas a los tejados de Caen, perfecto para un café por la mañana o una copa por la noche. Un dato útil: el apartamento está en el 3.er piso, sin ascensor. ¡Feliz estancia! ☕",
      it: "Benvenuti nell'appartamento Saint-Jean, nel pieno cuore di Caen! Vi trovate in rue Saint-Jean, a due passi da ristoranti, negozi e dal porto: tutto è raggiungibile a piedi. Il suo piccolo plus: un balcone con vista sui tetti di Caen, perfetto per un caffè al mattino o un aperitivo la sera. Da sapere: l'appartamento si trova al 3º piano, senza ascensore. Buon soggiorno! ☕",
    },
