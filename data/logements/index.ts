...
import { ecume, beauRivage, embruns, belleEpoque } from "./houlgate";
 ...
 */
export const logements: Logement[] = [granville, caen, fleur, mer, boheme, saintjean, quais, monnaie, ecume, beauRivage, embruns, belleEpoque];
